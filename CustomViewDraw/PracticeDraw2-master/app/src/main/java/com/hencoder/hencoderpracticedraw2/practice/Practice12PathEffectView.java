...
public class Practice12PathEffectView extends View {
    ...
    protected void onDraw(Canvas canvas) {
        ...
        dashPath.moveTo(120, 10);
        dashPath.lineTo(150, 40);
        dashPath.lineTo(120, 120);
        dashPath.close();
        PathEffect pathEffect4 = new PathDashPathEffect(dashPath, 40, 0, PathDashPathEffect.Style.TRANSLATE );
        ...
        paint.setPathEffect(pathEffect6);canvas.drawPath(path, paint);
        canvas.restore();
    }
}
